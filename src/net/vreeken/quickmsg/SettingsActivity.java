...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		bindPreferenceSummaryToValue(findPreference("imap_port"));
		bindPreferenceSummaryToValue(findPreference("imap_user"));
		bindPreferenceSummaryToValue(findPreference("smtp_server"));
		bindPreferenceSummaryToValue(findPreference("smtp_port"));
		bindPreferenceSummaryToValue(findPreference("smtp_user"));
